...
def compute_metrics(pred):
    ...
    # MAE should be scaled to represent the distance.
    # For validation, this scaling does not affect the result, as the argmin remains the same.
    return {
        # 'MAE': 30.0 * mae / 4096,
        'MAE': mae,
...
def main(
    ...
    if validation_data_paths:
        validation_dataset = ChronosDataset(
        ...
        # Add evaluation-related arguments only if validation dataset exists
